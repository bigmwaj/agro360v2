...
/**
 * TODO utiliser ce lien pour sécuriser les tokens
 ...
 */
@Component
public class AppAuthenticationTokenUtil implements Serializable {
	...
	private String doGenerateToken(Map<String, Object> claims, String subject) {
		...
		return Jwts.builder()
				...
				.setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_VALIDITY * 1_000))
