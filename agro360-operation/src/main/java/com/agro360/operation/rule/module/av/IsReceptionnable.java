...
@Component
public class IsReceptionnable extends AbstractRule<LigneBean> {
	...
	public boolean eval(ClientContext ctx, LigneBean bean) {
		...
		return CommandeTypeEnumVd.ACHAT.equals(type) 
				&& ( CommandeStatusEnumVd.APPR.equals(status) || CommandeStatusEnumVd.RECP.equals(status));
	}
}